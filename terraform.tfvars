parameters = {
  ...
  "user.dev.REDIS_HOST"        = { type = "String", value = "dev-redis-elasticache-cluster.uea7ce.0001.use1.cache.amazonaws.com" }##ELASTICACHE
  ...
  "elasticsearch.password" = { type = "SecureString", value = "RgPZMc8IE3VSgeFzqJ1i"}
  ...
  "shipping.dev.appVersion" = { type = "String", value = "1.0.3"}
